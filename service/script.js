// script.js — wires service.html to /service/* endpoints.
//
// service.html has two pre-existing markup bugs this file works around
// at runtime instead of requiring an HTML edit:
//   1. Some modal ids have a leading space (e.g. id=" viewModal"), so
//      getElementById('viewModal') would never match.
//   2. The first modal uses class="model"/"model-content"/"model-header"
//      instead of "modal"/... so the shared .modal CSS never applied.
// patchMarkupBugs() fixes both in-place on load.
