// reports.js — populates reports.html from live data.
// NOTE: there's no dedicated "reports" collection/endpoint in the backend,
// so the KPI cards and charts here are computed on the fly from the
// orders / inventory / service / account collections. The report table
// and generate/export modals remain static/demo since no backend endpoint
// exists yet to generate or store report files.
