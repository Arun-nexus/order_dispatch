...
class login(mongodbclient):
    ...
    def __init__(self, name: str, phone: int, email: str, company_name: str,
                 gst_number: str, role: str, password: str):
    ...
    def add(self, collection_name):
        try:
            ...
            result = super().add(collection_name=collection_name, dictionary=customer_docs)
            return result
        except Exception as e:
    ...
    def delete(self, collection_name, query, many=False):
        try:
            deleted_customer = super().delete_data(collection_name=collection_name, query=query, many=many)
